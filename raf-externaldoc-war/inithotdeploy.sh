...
#rm -rf WEB-INF/lib/raf-emaildoc-$version.jar
rm -rf WEB-INF/lib/raf-externaldoc-$version.jar
...
#ln -s ~/git_ozgur_yazilim/raf/raf-bpmn/target/classes/ WEB-INF/lib/raf-bpmn-$version.jar
#ln -s ~/git_ozgur_yazilim/raf/raf-cmis/target/classes/ WEB-INF/lib/raf-cmis-$version.jar
#ln -s ~/git_ozgur_yazilim/raf/raf-converter/target/classes/ WEB-INF/lib/raf-converter-$version.jar
#ln -s ~/git_ozgur_yazilim/raf/raf-core/target/classes/ WEB-INF/lib/raf-core-$version.jar
#ln -s ~/git_ozgur_yazilim/raf/raf-emaildoc/target/classes/ WEB-INF/lib/raf-emaildoc-$version.jar
ln -s ~/git_ozgur_yazilim/raf/raf-externaldoc/target/classes/ WEB-INF/lib/raf-externaldoc-$version.jar
#ln -s ~/git_ozgur_yazilim/raf/raf-forms/target/classes/ WEB-INF/lib/raf-forms-$version.jar
#ln -s ~/git_ozgur_yazilim/raf/raf-invoice/target/classes/ WEB-INF/lib/raf-invoice-$version.jar
#ln -s ~/git_ozgur_yazilim/raf/raf-jbpm/target/classes/ WEB-INF/lib/raf-jbpm-$version.jar
