 ...
 * @author oyas
 */
@ContentPanel( actionIcon = "fa-align-justify", view = ContentPanelPages.TableSmallViewPanel.class, icon = "fa-folder-open")
public class TableSmallViewPanel extends CollectionContentPanel{
