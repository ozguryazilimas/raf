...
public class JcrRest implements Serializable {
    ...
    public Response getIndexes(@QueryParam("index") String indexName) {
        Map<String, IndexDefinitionPayload> indexDefinitionPayloadMap = getIndexDefinitionPayloadMap();
    ...
    private Map<String, IndexDefinitionPayload> getIndexDefinitionPayloadMap() {
